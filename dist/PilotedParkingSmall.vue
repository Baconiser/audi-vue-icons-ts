<template>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M2,12.86 L2,2 L6.29,2 C9.635,2 10.835,3.395 10.835,5.375 C10.835,7.355 9.56,8.81 6.215,8.81 L3.545,8.81 L3.545,12.86 L2,12.86 Z M5.96,3.26 L3.545,3.26 L3.545,7.55 L5.96,7.55 C8.465,7.55 9.26,6.77 9.26,5.375 C9.26,3.98 8.465,3.26 5.96,3.26 Z" fill="currentColor" fill-rule="nonzero"/>
    </g>
</svg>
</template>
                            <script lang="ts">
