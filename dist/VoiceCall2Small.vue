<template>
    ...
    <path d="M13,5.5 C15.9,5.5 18.5,8.2 18.5,11 M17.5,23.3 L21.5,19.5 C21.7,19.3 21.7,18.7 21.5,18.5 L18.5,15.5 C18.3,15.3 17.7,15.3 17.5,15.5 L16,16.8 C16,16.8 15.3,17.9 11.1,13.7 L10.6,13.2 C6.3,8.9 7.5,8.5 7.5,8.5 L8.5,7.5 C8.7,7.3 8.7,6.7 8.5,6.5 L5.5,3.5 C5.3,3.3 4.7,3.3 4.5,3.5 L0.7,7.5 C0.7,7.5 6.5,17.1 17.5,23.3 Z" stroke="currentColor" stroke-width="1" fill="none" fill-rule="evenodd"/>
                            ...
                            <script lang="ts">
                                ...
                                @Component
                                export default class VoiceCall2Small extends Vue {
                                    @Prop({default: 24}) width!:number;
                                    @Prop({default: 24}) height!:number;
                                    @Prop({default: 'voice-call-2-small'}) title!:string;
                                }
                            </script> 