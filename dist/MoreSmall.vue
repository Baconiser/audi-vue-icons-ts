<template>
    ...
    <path d="M18.5,12.6 C19.1075132,12.6 19.6,12.1075132 19.6,11.5 C19.6,10.8924868 19.1075132,10.4 18.5,10.4 C17.8924868,10.4 17.4,10.8924868 17.4,11.5 C17.4,12.1075132 17.8924868,12.6 18.5,12.6 Z M11.5,12.6 C12.1075132,12.6 12.6,12.1075132 12.6,11.5 C12.6,10.8924868 12.1075132,10.4 11.5,10.4 C10.8924868,10.4 10.4,10.8924868 10.4,11.5 C10.4,12.1075132 10.8924868,12.6 11.5,12.6 Z M4.5,12.6 C5.10751322,12.6 5.6,12.1075132 5.6,11.5 C5.6,10.8924868 5.10751322,10.4 4.5,10.4 C3.89248678,10.4 3.4,10.8924868 3.4,11.5 C3.4,12.1075132 3.89248678,12.6 4.5,12.6 Z" stroke="currentColor" stroke-width="1" fill="none" fill-rule="evenodd"/>
                            ...
                            <script lang="ts">
                                ...
                                @Component
                                export default class MoreSmall extends Vue {
                                    @Prop({default: 24}) width!:number;
                                    @Prop({default: 24}) height!:number;
                                    @Prop({default: 'more-small'}) title!:string;
                                }
                            </script> 