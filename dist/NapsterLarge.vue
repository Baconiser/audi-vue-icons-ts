<template>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M18,25 L21,25 C21,25 24,25 24,28 L21,28 C21,28 18,28 18,25 Z M31,25 L28,25 C28,25 25,25 25,28 L28,28 C28,28 31,28 31,25 Z M13,18 C13,18 10,19.4 10,22 C10,24.6 13,25.9 13,25.9 L13,18 Z M36,18 C36,18 39,19.4 39,22 C39,24.6 36,25.9 36,25.9 L36,18 Z" fill="currentColor" fill-rule="nonzero"/>
    </g>
</svg>
</template>
                            <script lang="ts">
