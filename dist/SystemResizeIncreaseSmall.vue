<template>
    ...
    <path d="M12,6.5 L16.5,6.5 L16.5,11 M12.3684,10.6316 L16.5,6.5 L12.3684,10.6316 Z M10.6316,12.3684 L6.5,16.5 L10.6316,12.3684 Z M6.5,12 L6.5,16.5 L11,16.5 M11.5,0.5 C5.42486775,0.5 0.5,5.42486775 0.5,11.5 C0.5,17.5751322 5.42486775,22.5 11.5,22.5 C17.5751322,22.5 22.5,17.5751322 22.5,11.5 C22.5,8.58261861 21.3410748,5.78472557 19.2781746,3.72182541 C17.2152744,1.65892524 14.4173814,0.5 11.5,0.5 Z" stroke="currentColor" stroke-width="1" fill="none" fill-rule="evenodd"/>
                            ...
                            <script lang="ts">
                                ...
                                @Component
                                export default class SystemResizeIncreaseSmall extends Vue {
                                    @Prop({default: 24}) width!:number;
                                    @Prop({default: 24}) height!:number;
                                    @Prop({default: 'system-resize-increase-small'}) title!:string;
                                }
                            </script> 